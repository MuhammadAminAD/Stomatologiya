export const styles = {
    Container: "max-w-[1300px] w-18/20 mx-auto",
    FlexCenter: "flex items-center justify-center",
    AbsoluteCenter: "absolute top-1/2 left-1/2 -translate-1/2",
    footerTitle: 'font-normal text-[22px] text-[#FFFFFF] lg:mb-[50px] mb-[25px]',
    appoinmentLabel: 'font-normal text-[14px] leading-[20px] text-[#18181B]',
